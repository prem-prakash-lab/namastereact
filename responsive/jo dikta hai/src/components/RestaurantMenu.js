    ...
    <div className="">
      <div className="bg-black my-4 shadow-2xl">
          <div className="lg:flex justify-center pt-4 ">
                ...
                <img className="px-24 mt-3" src={image_id + restaurant?.cloudinaryImageId}/>
          </div>
          <div className=" lg:flex lg:justify-between p-4">
                <h2 className="text-white text-1xl text-center">AreaName: {restaurant?.areaName}</h2>
                <h2 className="text-white text-1xl text-center">Rating: {restaurant?.avgRating} star</h2>
                <h2 className="text-white text-1xl text-center">locality: {restaurant?.locality}</h2>
                <h2 className="text-white text-1xl text-center">city:{restaurant?.city}</h2>
                <h2 className="text-white text-1xl text-center">{restaurant?.costForTwoMessage}</h2>
          </div>
      </div>
      <div className="">
